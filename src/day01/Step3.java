...
public class Step3 {    // class s
    ...
    public static void main(String[] args) {    // main s
        ...
        // 4. 실수 자료형
        // [8] double : [ 소수점 17자리까지 표현 ] , 자바는 모든 실수 값을 기본으로 double
        double d1 = 0.123456789123456789;    System.out.println("d1 = " + d1);

        // [9] float : [ 소수점 8자리까지 표현] , 뒤에 F 붙입니다.
        float f1 = 0.12345678912345789F;     System.out.println("f1 = " + f1);
