...
public class Step1 {
    public static void main(String[] args) {
        ...
        // [1] 일반예외 : 발생할 수도 있고 안할수도 있고 , 컴파일러 무조건 예외처리 검사
        try {
            // =============예외가 발생 할 것 같은 ===================== //
        ...
        String str3 = "100";
        String str4 = "1aa";
        int result1 = Integer.parseInt(str3);     // Integer클래스 : int 형 관련 클래스 , parseInt(); 문자열 --> 정수형 타입 변환
                                // parseInt(); static 함수인가요? 맞다. -> 그래서 객체없이 클래스로 불러올 수 있다.
        ...
        try {
            ...
            int ch = scanner.nextInt();     //  만약에 문자 입력 시 예외발생 : java.util.InputMismatchException
