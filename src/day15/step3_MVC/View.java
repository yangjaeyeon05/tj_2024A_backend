...
public class View {
    ...
    public void updateView(){
        ...
        System.out.print(">> [수정U] 기존 이름 : ");      String oldName = scan.next();
        System.out.print(">> [수정U] 새로운 이름 : ");     String newName = scan.next();
    ...
    public void deleteView(){
        ...
        System.out.print(">> [삭제D] 삭제할 이름 : ");     String name = scan.next();
